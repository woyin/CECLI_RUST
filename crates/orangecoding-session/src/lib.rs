//! OrangeCoding 会话管理模块
//!
//! `orangecoding-session` 实现了基于 JSONL 树存储的会话管理系统。
...
//!
//! ```rust,no_run
//! use orangecoding_session::{SessionManager, Session};
//! use std::path::PathBuf;
//!
//! # async fn example() -> Result<(), orangecoding_session::SessionError> {
//! let manager = SessionManager::new(PathBuf::from("~/.orangecoding/sessions"));
