//! ChengCoding 核心类型和 trait 库
//!
//! `ceair-core` 是 ChengCoding 系统的基础 crate，定义了所有其他 crate 共享的
//! 核心类型、错误处理、事件系统和消息格式。
//!
//! # 模块结构
//!
...
//!
//! ```rust
//! use chengcoding_core::{AgentId, SessionId, AgentRole, AgentStatus, TokenUsage};
//! use chengcoding_core::message::{Conversation, Message};
//!
//! // 创建代理标识
