...
//!
//! ```rust
//! use orangecoding_core::{AgentId, SessionId, AgentRole, AgentStatus, TokenUsage};
//! use orangecoding_core::message::{Conversation, Message};
//!
//! // 创建代理标识
...
pub use error::{ErrorKind, OrangeError, Result};
