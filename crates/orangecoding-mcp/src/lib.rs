//! OrangeCoding MCP（Model Context Protocol）实现
//!
//! 本 crate 实现了 MCP 协议，为 OrangeCoding AI 编码助手提供
...
//!
//! ```rust,no_run
//! use orangecoding_mcp::server::{McpServer, McpCapabilities, ToolDefinition};
//! use orangecoding_mcp::transport::StdioTransport;
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
//!     let server = McpServer::new(
//!         "orangecoding-mcp-server",
//!         "0.1.0",
