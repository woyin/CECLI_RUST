//! ChengCoding MCP（Model Context Protocol）实现
//!
//! 本 crate 实现了 MCP 协议，为 ChengCoding AI 编码助手提供
...
//!
//! ```rust,no_run
//! use chengcoding_mcp::server::{McpServer, McpCapabilities, ToolDefinition};
//! use chengcoding_mcp::transport::StdioTransport;
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
//!     let server = McpServer::new(
//!         "chengcoding-mcp-server",
//!         "0.1.0",
