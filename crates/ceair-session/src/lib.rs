//! CEAIR 会话管理模块
//!
//! `ceair-session` 实现了基于 JSONL 树存储的会话管理系统。
...
//!
//! ```rust,no_run
//! use ceair_session::{SessionManager, Session};
//! use std::path::PathBuf;
//!
//! # async fn example() -> Result<(), ceair_session::SessionError> {
//! let manager = SessionManager::new(PathBuf::from("~/.ceair/sessions"));
