...
//!
//! ```rust
//! use orangecoding_mesh::shared_state::SharedState;
//! use orangecoding_mesh::agent_registry::{AgentRegistry, AgentInfo};
//! use orangecoding_core::{AgentId, AgentRole, AgentStatus};
//!
//! // 创建共享状态
...
/// Agent间直接通信模块 - 点对点消息传递与广播
pub mod agent_comm;

/// 任务协商协议模块 - 请求-提议-接受/拒绝流程
pub mod negotiation;

/// 任务重分配模块 - Agent间的任务交接管理
