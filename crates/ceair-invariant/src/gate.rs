...
mod tests {
    ...
    fn parse_auth_file_change() {
        let diff = "\
diff --git a/crates/ceair-control-server/src/auth.rs b/crates/ceair-control-server/src/auth.rs
--- a/crates/ceair-control-server/src/auth.rs
+++ b/crates/ceair-control-server/src/auth.rs
@@ -10,3 +10,5 @@
+added line 1
+added line 2
";
        ...
        assert_eq!(
            ...
            "crates/ceair-control-server/src/auth.rs"
        );
        assert!(report
            .impacts[0]
            .affected_categories
