//! ChengCoding 多代理网格系统
//!
//! `chengcoding-mesh` 是 ChengCoding 系统的多代理协调 crate，负责管理代理之间的
...
//!
//! ```rust
//! use chengcoding_mesh::shared_state::SharedState;
//! use chengcoding_mesh::agent_registry::{AgentRegistry, AgentInfo};
//! use chengcoding_core::{AgentId, AgentRole, AgentStatus};
//!
//! // 创建共享状态
