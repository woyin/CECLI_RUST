...
impl ModelRoleRouter {
    ...
    ///
    /// 支持的环境变量：
    /// - `OrangeCoding_MODEL_DEFAULT` — 默认模型
    /// - `OrangeCoding_MODEL_SMOL` — 小模型
    /// - `OrangeCoding_MODEL_SLOW` — 慢模型
    /// - `OrangeCoding_MODEL_PLAN` — 计划模型
    /// - `OrangeCoding_MODEL_COMMIT` — 提交模型
    ///
    ...
    pub fn from_env() -> Self {
        ...
        let env_mappings = [
            ("OrangeCoding_MODEL_DEFAULT", ModelRole::Default),
            ("OrangeCoding_MODEL_SMOL", ModelRole::Smol),
            ("OrangeCoding_MODEL_SLOW", ModelRole::Slow),
            ("OrangeCoding_MODEL_PLAN", ModelRole::Plan),
            ("OrangeCoding_MODEL_COMMIT", ModelRole::Commit),
        ];
...
mod tests {
    ...
    fn test_from_env() {
        // 设置环境变量，验证从环境变量加载
        std::env::set_var("OrangeCoding_MODEL_DEFAULT", "openai/gpt-4o:medium");
        std::env::set_var("OrangeCoding_MODEL_SMOL", "gpt-4o-mini");
        ...
        // 清理环境变量
        std::env::remove_var("OrangeCoding_MODEL_DEFAULT");
        std::env::remove_var("OrangeCoding_MODEL_SMOL");
    }
}
